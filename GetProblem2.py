...
#print(get_problem_response.data.description)
#linea = str(get_problem_response.data.comment)+";"+str(get_problem_response.data.description)+";"+str(get_problem_response.data.recommendation)+";"+str(get_problem_response.data.id)
linea = str(get_problem_response.data.comment)+";"+str(get_problem_response.data.description)+";"+str(get_problem_response.data.recommendation)
print(linea)
#for x in get_problem_response.data:
#     print(get_problem_response.data[x])
